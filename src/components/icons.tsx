/** Inline SVG icons used in more than one place. All are decorative, so they're
 *  hidden from assistive tech — the link or button around them carries the name. */
...
/** Forward arrow on "View …" / "Read …" CTAs. */
...
/** Back arrow on the inner pages' nav bars. */
