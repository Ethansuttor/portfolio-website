...
function HeroProjectCard({ project }: { project: Project }) {
  return (
    <Link
      ...
      className="group flex flex-col bg-surface-container-high border border-outline-variant/20 hover:border-primary-container/60 hover:shadow-2xl hover:shadow-primary/5 transition-all duration-300 cursor-pointer overflow-hidden mb-6"
